...
Product.create!([
  {name: "Dyson V11 Animal Cordless Stick Vacuum", price: "599.99", description: "Engineered for whole-home, deep cleaning with suction power, run time and tools designed to deep clean your whole home. Dyson DLS™ technology automatically senses and adapts to changes in floor type to extend run time and provide the right balance of power and run time when you need it.", stock: 2, supplier_id: 3, user_id: nil},
  {name: "Gatorade", price: "2.99", description: "Gatorade is a brand of flavored non-carbonated sports drinks manufactured by the Quaker Oats Company, now a division of PepsiCo. Intended for consumption during physically active occasions, Gatorade beverages are formulated to rehydrate and replenish fluid, carbohydrates and electrolytes.", stock: 10, supplier_id: 3, user_id: nil},
  {name: "hi", price: "599.99", description: "Engineered for whole-home, deep cleaning with suction power, run time and tools designed to deep clean your whole home. Dyson DLS™ technology automatically senses and adapts to changes in floor type to extend run time and provide the right balance of power and run time when you need it.", stock: 3, supplier_id: 3, user_id: nil},
  {name: "Kit Kat", price: "1.99", description: "A KIT KAT® bar is made of three layers of wafer separated and covered by an outer layer of chocolate. The standard bars consist of four pieces, called fingers, and each finger can be snapped from the bar as an individual piece.", stock: 6, supplier_id: 2, user_id: nil},
  {name: "Blue Yeti USB Microphone (Silver)", price: "99.99", description: "A simple, yet powerfully effective tool for content creators, the Blue Microphones Yeti is a USB mic offering a broadcast-quality sound, a rugged design, and multiple recording modes to suit your needs. The Yeti, offfered here in a silver finish, has become a go-to mic for people who record podcasts, and who stream on YouTube, Twitch, Facebook Live, and other similar platforms.", stock: 4, supplier_id: 2, user_id: nil},
  {name: "Goupsky Roller Skate Shoes for Women (Blue)", price: "79.99", description: "58mm wheels give faster roll time for extreme speed.83A urethane is medium soft and grippy for everything from concrete to asphalt. Great for cruising through the park, skating along the boardwalk or showing off in your neighborhood, these skates can take the terrain.", stock: 1, supplier_id: 2, user_id: nil},
  {name: "Febreze Blossom & Breeze Vaporizador 300 Ml", price: "7.99", description: "Febreze AIR doesn't just mask odors, it cleans away odors with OdorClear Technology, leaving your air with a light, fresh scent. So when something stinky gets in your way, reach for Febreze AIR to eliminate odors on the spot.", stock: 16, supplier_id: 1, user_id: nil},
  {name: "Kraft Macaroni & Cheese", price: "3.99", description: "Kraft Macaroni and Cheese has no artificial flavors, preservatives or dyes. But it still has the great taste you know and love. Most of our mac and cheese products have 10% of the recommended daily value for calcium and 8 or 9 grams of protein.", stock: 8, supplier_id: 1, user_id: nil},
  {name: "Roomba", price: "299.99", description: "Roomba is a series of autonomous robotic vacuum cleaners sold by iRobot. Introduced in September 2002, they have a set of sensors that enable them to navigate the floor area of a home. These sensors can detect the presence of obstacles, particularly dirty spots on the floor, and steep drops (e.g. to avoid falling down stairs).", stock: 3, supplier_id: 1, user_id: nil},
  {name: "rewrwr", price: "3344444.0", description: "fdsfskfsmfksfmkskmf", stock: 22, supplier_id: 1, user_id: 1},
  {name: "finnyrenes", price: "20202.0", description: "kjdsfndjsnfjsdnfksdnf", stock: 20, supplier_id: 1, user_id: 1}
])
Image.create!([
...
CartedProduct.create!([
  ...
  {user_id: 2, product_id: 1, quantity: 2, status: nil, order_id: nil},
  {user_id: 2, product_id: 1, quantity: 4, status: nil, order_id: nil},
